...
function createBallpit(e, t = {}) {
  ...
  // OPTIMIZATION: Cap pixel ratio to improve performance on high-DPI screens
  i.maxPixelRatio = 1.5;
...
class BallpitBg extends HTMLElement {
    constructor() {
        super();
    ...
    connectedCallback() {
        const count = parseInt(this.getAttribute('count')) || 30;
        ...
        try {
            if (this.hasAttribute('colors')) {
                colors = JSON.parse(this.getAttribute('colors'));
            }
        } catch (e) {
...
customElements.define('ballpit-bg', BallpitBg);
